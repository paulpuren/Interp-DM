...
# Example:
#   bash scripts/shanghai/eval_flex_shanghai.sh
#   CUDA_VISIBLE_DEVICES=0 bash scripts/shanghai/eval_flex_shanghai.sh
#   TOTAL_INTERP_STEPS_EVAL=20 BATCH_SIZE=8 bash scripts/shanghai/eval_flex_shanghai.sh
...
FLEX_MODEL_SIZE="${FLEX_MODEL_SIZE:-medium}"
FLEX_MLP_RATIO="${FLEX_MLP_RATIO:-4}"
